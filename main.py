...
advice=pd.read_csv('datasets/workout_df.csv')
...
def helper(dis):
    ...
    d8=diet[diet['Disease']==dis]['Diet']
    d8=[col for col in d8.values]

    adv=advice[advice['disease']==dis]['workout']
    return descr,pre,med,d8,adv
...
def predict():
    if request.method == 'POST':
        ...
        descr,pre,med,d8,adv=helper(predicted_disease)
        return render_template('index.html',predicted_disease=predicted_disease,descr=descr,pre=pre,med=med,d8=d8,adv=adv)
